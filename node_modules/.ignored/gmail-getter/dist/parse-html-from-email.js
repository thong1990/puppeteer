...
exports.parseHtmlFromEmail = void 0;
/**
 ...
 */
const parseHtmlFromEmail = (email) => {
    if (!email) {
    ...
    if (!part) {
        throw new Error(`Failed to parse HTML from email - couldn't find HTML body part in the email.
      \n${JSON.stringify(email.payload.parts)}`);
    }
    const html = Buffer.from(part.body.data, 'base64').toString('ascii');
    return html;
};
exports.parseHtmlFromEmail = parseHtmlFromEmail;
